...
<body>
    ...
    <asp:SqlDataSource ID="DSSpese" runat="server"
        ...
        SelectCommand="SELECT Expenses_Id, Projects_Id, Expenses.Persons_id, ExpenseType_id, Date, Amount, Comment, CreditCardPayed, CompanyPayed, CancelFlag, InvoiceFlag, Expenses.CreatedBy, Expenses.CreationDate, Expenses.LastModifiedBy, Expenses.LastModificationDate, AccountingDate, TipoBonus_id, Persons.Name, Expenses.ClientManager_id, Expenses.AccountManager_id, Expenses.Company_id, Expenses.AdditionalCharges FROM Expenses INNER JOIN Persons ON Expenses.Persons_id = Persons.Persons_id  WHERE (Expenses_Id = @Expenses_Id)"
