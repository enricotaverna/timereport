			...
			<form id="form1" runat="server" data-parsley-validate>
			   ...
			   <a href="AuditLog.aspx?RecordId=&amp;TableName=Expenses&amp;TYPE=U&amp;key=&lt;Expenses_Id=&gt;">
				...
				<asp:SqlDataSource ID="DSSpese" runat="server"
					...
					SelectCommand="SELECT Expenses_Id, Projects_Id, Expenses.Persons_id, ExpenseType_id, Date, Amount, Comment, CreditCardPayed, CompanyPayed, CancelFlag, InvoiceFlag, CreatedBy, CreationDate, LastModifiedBy, LastModificationDate, AccountingDate, TipoBonus_id, Persons.Name, Expenses.ClientManager_id, Expenses.AccountManager_id, Expenses.Company_id FROM Expenses INNER JOIN Persons ON Expenses.Persons_id = Persons.Persons_id WHERE (Expenses_Id = @Expenses_Id)"
					InsertCommand="INSERT INTO Expenses(Projects_Id, Persons_id, Date, ExpenseType_Id, Amount, CancelFlag, CreditCardPayed, CompanyPayed, InvoiceFlag, Comment, CreatedBy, CreationDate, AccountingDate, TipoBonus_id, ClientManager_id, AccountManager_id, Company_id) VALUES (@Projects_Id, @Persons_id, @Date, @ExpenseType_id, @Amount, @CancelFlag, @CreditCardPayed, @CompanyPayed, @InvoiceFlag, @Comment, @CreatedBy, @CreationDate, @AccountingDate, @TipoBonus_id, @ClientManager_id, @AccountManager_id, @Company_id);"
