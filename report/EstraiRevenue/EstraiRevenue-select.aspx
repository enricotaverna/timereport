...
<body>    
    ...
    <div class="input nobottomborder">
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="Inserire data report" ControlToValidate="TBDataDA" Display="none"></asp:RequiredFieldValidator>
    </div> 
    ...
    <div class="input nobottomborder">
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Inserire data report" ControlToValidate="TBDataA" Display="none"></asp:RequiredFieldValidator>
    </div> 
