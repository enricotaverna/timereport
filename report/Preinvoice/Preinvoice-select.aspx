<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Preinvoice-select.aspx.cs" Trace="false" Inherits="report_ricevute_select" EnableViewState="True" %>
        ...
        <form id="FVForm" runat="server" data-parsley-validate>
            ...
            <div class="row justify-content-center">
                ...
                <div id="FormWrap" class="StandardForm col-5">
                    ...
                    <div class="formtitle">Selezione Prefattura</div>
                    ...
                    <div class="input nobottomborder">
                        <div class="inputtext">Persona</div>
                            <asp:ListBox ID="LBPersone" runat="server" SelectionMode="Multiple" Visible="false" CssClass="SumoDLL" AppendDataBoundItems="True" DataTextField="Name" DataValueField="Persons_id"></asp:ListBox>
                        </div>
