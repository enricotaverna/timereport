...
<body>
        ...
        <form id="form1" runat="server">
            ...
            <div class="row justify-content-center ">
                ...
                <div class="form-group row justify-content-center">
                                ...
                                <div style="position: absolute">
                                    ...
                                    <span>
                                        <asp:ListBox ID="CBLPersone" runat="server" SelectionMode="Multiple" DataSourceID="DSPersone" DataTextField="name" Style="text-align: left"
                                            DataValueField="Persons_id" meta:resourcekey="CBLPersoneResource1"></asp:ListBox>
                                    </span>
                                </div>
                            </div>
                            <div class="col-3">
                    ...
                    <div class="row mt-2 ms-2" id="DivOpportunitaSpese" runat="server">
                        <!-- margine per separare le righe -->
                        ...
                        <div class="col-6">
                            <div style="position: absolute">
                                <!-- aggiunto per evitare il troncamento della dropdonwlist -->
                                <span>
                                    <asp:ListBox ID="CBLOpportunita" runat="server" SelectionMode="Multiple"></asp:ListBox>
                                </span>
                            </div>
                        </div>
                        <div class="col-6">
                            <div style="position: absolute">
                                ...
                                <span>
                                    <asp:ListBox ID="CBLTipoSpese" runat="server" SelectionMode="Multiple" DataSourceID="DSTipoSpese" DataTextField="name" Style="text-align: left"
                                        DataValueField="ExpenseType_Id"></asp:ListBox>
                                </span>
                            </div>
                        </div>
                    </div>
    ...
    <div class="row justify-content-center pt-3">
        ...
        <div id="FormWrap" class="StandardForm col-9">
            ...
            <div class="input nobottomborder" id="DivManager" runat="server">
                <div class="inputtext">Mngr o Del.Owner</div>
    ...
    <script>
        ...
        $(function () {
            ...
            $('#CBLOpportunita').SumoSelect({ placeholder: 'Opportunità', search: true });
            $('#CBLTipoSpese').SumoSelect({ placeholder: 'Tipo spesa', search: true });

            $('#CBLProgetti')[0].sumo.optDiv.css('width', '550px'); // fa in modo che la tendina per le opportunità sia larga 550px
            $('#CBLOpportunita')[0].sumo.optDiv.css('width', '550px'); // fa in modo che la tendina per le opportunità sia larga 550px
