<%@ Page Language="C#" AutoEventWireup="true" CodeFile="menu2.aspx.cs" Inherits="menu" %>
...
<script src="assets/bootstrap/js/bootstrap.bundle.min.js"></script>                 <!-- Bootstrap 5 Core -->
<script src="include/BTmenu/menukit.js"></script>                                   <!-- Bootstrap 5 Menu -->
...
<link href="include/bootstrap/css/bootstrap.min.css" rel="stylesheet" />            <!-- Bootstrap 5 Core -->
<link href="/timereport/include/newstyle.css" rel="stylesheet" type="text/css" />
<link href="/timereport/include/dashboard.css" rel="stylesheet" type="text/css" />
<link href="include/BTmenu/menukit.css" rel="stylesheet" />                         <!-- Bootstrap 5 Menu -->
 ...
 <div class="container">
  ...
  <div class="collapse navbar-collapse" id="main_nav">
	...
	<ul class="navbar-nav">
		...
		<li class="nav-item dropdown">
			<button data-bs-toggle="dropdown" class="btn btn-success dropdown-toggle" type="button"> Forms  </button>
			<div class="dropdown-menu dropdown-menu-end">
				<form class="px-4 py-3" style="min-width:250px">
				    <div class="mb-3">
