...
if (sUserLevel == AUTH_ADMIN) {
    ...
    addmenu(menu = ["ADMIN_MainMenu",
        , , 180, 1, "", style1, , "", effect, , , , , , , , , , , ,
        , "Gestione Chiusura", "show-menu=ADMIN_CutOff", , , 1
        ...
        , "Modifiche massive", "show-menu=ADMIN_MassChange", , , 1
        , "Persone", "show-menu=ADMIN_Persone", , , 1
        , "Gestione Economics", "show-menu=ADMIN_Economics", , , 1
        , "Tabelle valori", "show-menu=ADMIN_Tabelle", , , 1
        , "Report", "show-menu=ADMIN_Export", , , 1
    ]);

    addmenu(menu = ["ADMIN_CutOff",
        , , 180, 1, "", style1, , "", effect, , , , , , , , , , , ,
    ...
    addmenu(menu = ["ADMIN_Economics",
        , , 180, 1, "", style1, , "", effect, , , , , , , , , , , ,
        , "Master data", "show-menu=ADMIN_economics_masterdata", , , 1
        , "Import data", "show-menu=ADMIN_economics_import", , , 1
    ...
    addmenu(menu = ["ADMIN_economics_import",
        , , 180, 1, "", style1, , "", effect, , , , , , , , , , , ,
...
if (sUserLevel == AUTH_MANAGER) {
    ...
    addmenu(menu = ["MULTI_Training",
        , , 180, 1, "", style1, , "", effect, , , , , , , , , , , ,
        , "Training plan", "show-menu=MNGR_TrainingPlan", , , 1
        , "Report&Download", "show-menu=MNGR_TrainingReport", , , 1
    ]);

    addmenu(menu = ["MNGR_TrainingPlan",
        , , 180, 1, "", style1, , "", effect, , , , , , , , , , , ,
...
if (sUserLevel == AUTH_EMPLOYEE || sUserLevel == AUTH_TEAMLEADER  ) {
    ...
    addmenu(menu = ["MULTI_Training",
        , , 180, 1, "", style1, , "", effect, , , , , , , , , , , ,
        , "<img src=/timereport/images/icons/16x16/S_PROTOK.gif border=0>&nbsp;Training Plan", "/timereport/m_gestione/training/TrainingPlan_view.aspx", , , 1
        , "<img src=/timereport/images/icons/16x16/modifica.gif border=0>&nbsp;Valuta corsi", "/timereport/m_gestione/training/TrainingPlan_evaluate.aspx", , , 1
    ]);
...
if (sUserLevel == AUTH_EXTERNAL) {
    ...
    addmenu(menu = [
        ...
        10, 12, , 0, , XPMainStyle, 1, "left", effect, , 1, , , , , , , , , ,
        , "Home", "/timereport/menu.aspx", , "Back to the home page", 1 // "Description Text", "URL", "Alternate URL", "Status", "Separator Bar"
        , (sLingua == 'it') ? "Inserisci&nbsp;Dati&nbsp;&nbsp;" : "Input&nbsp;Data&nbsp;&nbsp;", "show-menu=EXT_Inserisci", , "", 1
        , "Report&nbsp;&nbsp;", "show-menu=COMMON_Report", , "", 1
        , (sLingua == 'it') ? "Utilita'&nbsp;&nbsp;" : "Utility&nbsp;&nbsp;", "show-menu=COMMON_Utilita", , "", 1
        , "Logout&nbsp;&nbsp;", "/timereport/logout.aspx", , "", 1
    ]);

    addmenu(menu = ["EXT_Inserisci",
        , , 180, 1, "", style1, , "", effect, , , , , , , , , , , ,
        , (sLingua == 'it') ? "<img src=/timereport/images/icons/16x16/hours.gif border=0>&nbsp;Ore" : "<img src=/timereport/images/icons/16x16/hours.gif border=0>&nbsp;Hours", "/timereport/input.aspx?type=hours", , , 1
        , (sLingua == 'it') ? "<img src=/timereport/images/icons/16x16/expenses.gif border=0>&nbsp;Spese" : "<img src=/timereport/images/icons/16x16/expenses.gif border=0>&nbsp;Expenses", "/timereport/input.aspx?type=expenses", , , 1
        , (sLingua == 'it') ? "<img src=/timereport/images/icons/16x16/export.gif border=0>&nbsp;Upload spese" : "<img src=/timereport/images/icons/16x16/export.gif border=0>&nbsp;Upload expenses" , "/timereport/m_utilita/upload-expenses-xls.aspx", , , 1
    ]);
}

// solo admin e trainer hanno il menu Training completo
if (sUserLevel == AUTH_ADMIN || sUserLevel == AUTH_TRAINER) {

    addmenu(menu = ["MULTI_Training",
        , , 180, 1, "", style1, , "", effect, , , , , , , , , , , ,
        , "Catalogo", "show-menu=ADMIN_CatalogoCorsi", , , 1
        , "Training plan", "show-menu=ADMIN_TrainingPlan", , , 1
        , "Report&Download", "show-menu=MNGR_TrainingReport", , , 1
    ]);

    addmenu(menu = ["ADMIN_CatalogoCorsi",
        , , 180, 1, "", style1, , "", effect, , , , , , , , , , , ,
    ...
    addmenu(menu = ["ADMIN_TrainingPlan",
        , , 180, 1, "", style1, , "", effect, , , , , , , , , , , ,
...
// **** MANAGER e ADMIN **** ///
addmenu(menu = ["MNGR_Progetti",
    , , 180, 1, "", style1, , "", effect, , , , , , , , , , , ,
    , "Anagrafiche", "show-menu=MNGR_AnagraficaProgetti", , , 1
    , "Economics", "show-menu=MNGR_Economics", , , 1
    , "Reporting", "show-menu=MNGR_ReportManager", , , 1
]);

addmenu(menu = ["MNGR_AnagraficaProgetti",
    , , 180, 1, "", style1, , "", effect, , , , , , , , , , , ,
...
addmenu(menu = ["MNGR_ReportManager",
    , , 180, 1, "", style1, , "", effect, , , , , , , , , , , ,
